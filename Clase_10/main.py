...
array_nombres = crear_array(3,0)
matriz_notas = crear_matriz(3,3,0)

# print(array_nombres)
# mostrar_matriz(matriz_notas)

while True:
    print("1. Cargar nombres alumnos\n2. Cargar notas de cada trimestre\n3. Mostrar alumnos\n4. Mostrar promedio de notas\n5. Mostrar nombre de los alumnos que se llevan la materias\n6. Mostrar nombre de los alumnos que como nota final les quedo un aplazo\n7. Ordenar alumnos alfabeticamente\n8. Ordenar los alumnos por nota del primer trimestre\n9. Salir")

    opcion = int(input("Su opcion: "))
    while opcion > 9 or opcion < 1:
    ...
    if opcion == 1:
        ...
        ordenar_alumnos_por_nombre(array_nombres,matriz_notas)
        mostrar_alumnos(array_nombres,matriz_notas)
    elif opcion == 8:
        ordenar_alumnos_por_nota_primer_trimestre(array_nombres,matriz_notas)
        mostrar_alumnos(array_nombres,matriz_notas)
    elif opcion == 9:
        print("Saliendo...")
        break
