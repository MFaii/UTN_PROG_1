...
def mostrar_usuarios(
    lista_nombres: list, lista_edades: list, lista_legajos: list, lista_sueldos: list
) -> None:
...
def cargar_usuarios(
    ...
    if (
        type(lista_edades) == list
        and type(lista_nombres) == list
        and type(lista_legajos) == list
        and type(lista_sueldos) == list
    ):
        for i in range(len(lista_nombres)):
